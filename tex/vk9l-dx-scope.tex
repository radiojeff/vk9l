...
\newenvironment{acknowledgements}{%
  \renewcommand{\abstractname}{Acknowledgements}% Rename Abstract to 
Acknowledgements
  \begin{abstract}
}{%
  \end{abstract}
...
{\small{Rev 1.20}}\\[2mm]
July {19{\textsuperscript{th}}} - August {1\textsuperscript{st}}, 2024\\[1cm]
}
...
mentoring me in all areas of DX, contesting and reminding me to keep having 
fun.
\item Mark Aaker {\qrz{K6UFO}} for his support and advice and good talks
over a glass of wine.
\item Al Rovner, {\qrz{K7AR}} and Bob Norin, {\qrz{W7YAQ}} for their advice 
and information about Lord Howe Island.
\item Bob Schmieder, {\qrz{KK7EK}} for his inspiration to follow my 
{\textit{DX-Aku}}.
...
\captionsetup{width=0.8\linewidth}
\captionof{figure}[Location]{Proximity of LHI with Australia and the North 
...
\end{tabular}}
\captionsetup{width=0.8\linewidth}
\captionof{table}[Rank of VK9L]{Comparison of VK9L with other sampled DX 
entities for
comparison.}
\label{compare}
\end{minipage}
...
\captionsetup{width=0.8\linewidth}
\captionof{figure}[Nearby Countries]{Location of Lord Howe relative to 
...
\captionsetup{width=0.8\linewidth}
\captionof{figure}[Weather Pattern]{A weather chart showing trends of 
temperature,
...
\end{tabular}}
\captionsetup{width=0.8\linewidth}
\captionof{table}[Operator Evaluation]{Self evaluation of the author's skills 
on various roles and abilities on the expedition.}
\label{eval}
\end{minipage}
\vskip3mm

If this was a Team event, each member should have an overlap of 
two or three (or more) areas of expertise. \par
For example a team member of value would have a combination of 
three or more features like:
...
\begin{tabular}{|l|l|} \hline
{\textbf{Time Range (UTC+10.5)}} & {\textbf{Activity}} \\ \hline
0000 - 0500 & Work \\ \hline
0500 - 1000 & Off  \\ \hline
1500 - 2000 & Work \\ \hline
2000 - 0300 & Off  \\ \hline
0300 - 0800 & Work \\ \hline
0800 - 1300 & Off  \\ \hline
1300 - 1800 & Work \\ \hline
1800 - 2300 & Off  \\ \hline
etc\ldots & \\ \hline
\end{tabular}}
\captionsetup{width=0.8\linewidth}
